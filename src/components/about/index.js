  ...
  return (
    <Box>
      ...
      <Text>
        ...
        <Box>Find me on <Text inline color="blue"><Link inline href='https://www.youtube.com/channel/UC0xE-0jjE0IBAxhozD4Hjfg'>Youtube</Link></Text> and <Text inline color="blue"><Link inline href='https://lyricstranslate.com/en/translator/jasonyz500'>LyricsTranslate</Link></Text>.</Box>
      </Text>
    </Box>
  );
}
