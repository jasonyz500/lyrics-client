  ...
  return (
    <Box>
      ...
      <Text>
        ...
        <Box display="flex">Find me on <Text display="inline" color="shopping"><Link display="inline" href='https://www.youtube.com/channel/UC0xE-0jjE0IBAxhozD4Hjfg'>Youtube</Link></Text> and <Text inline color="shopping"><Link inline href='https://lyricstranslate.com/en/translator/jasonyz500'>LyricsTranslate</Link></Text>.</Box>
      </Text>
    </Box>
  );
}
